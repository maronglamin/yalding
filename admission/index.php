      ...
      <div class="login-wrap">
        ...
        <div>
          ...
          if ($_POST) {
            ...
            $query = $db->query("SELECT * FROM `stud_adm_info` WHERE `email` = '{$email}' OR `new_email` = '{$email}'");
            $user = mysqli_fetch_assoc($query);

            $que = $db->query("SELECT * FROM `stud_adm_info` WHERE `email` = '{$email}' OR `new_email` = '{$email}'");
