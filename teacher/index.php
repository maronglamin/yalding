      ...
      <div class="login-wrap">
        ...
        <div>
          ...
          if ($_POST) {
            ...
            $query = $db->query("SELECT * FROM `staff` WHERE `email` = '{$email}'");
            ...
            $delquery = $db->query("SELECT * FROM `staff` WHERE `email` = '{$email}' AND `deleted` != 0");
            ...
            $permitQuery = $db->query("SELECT * FROM `staff` WHERE `email` = '{$email}' AND `permitted` = 0");
        ...
        <a href="components/signup.php" class="btn btn-info btn-lg btn-block" type="submit">Signup</a>
      </div>
    </form>
  </div>
